        <div class="modal fade" id="multi_train_form" tabindex="-1" role="dialog" aria-labelledby="fm_cdr_params_ttl" aria-hidden="true" 
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content y-modal-shadow">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4 text-center">
                                            <div class='custom-control custom-checkbox'>
                                                <input id='train_param-1' type='checkbox' class='custom-control-input' style="margin-left:15px;" data-shrt="ДП">
                                                <label class='custom-control-label y-gray-text' for='train_param-1'>ДП</label>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-4 text-center">
                                            <div class='custom-control custom-checkbox'>
                                                <input id='train_param-3' type='checkbox' class='custom-control-input' style="margin-left:15px;" data-shrt="НД">
                                                <label class='custom-control-label y-gray-text' for='train_param-3'>НД</label>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-4 text-center">
                                            <div class='custom-control custom-checkbox'>
                                                <input id='train_param-2' type='checkbox' class='custom-control-input' style="margin-left:15px;" data-shrt="ДЧ">
                                                <label class='custom-control-label y-gray-text' for='train_param-2'>ДЧ</label>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-footer y-modal-footer-bk">
                        ...
                        <button id="multi_train_params_ok" class="btn btn-primary y-shad">Ok</button>
                    </div>
                </div>
            </div>
        </div>
